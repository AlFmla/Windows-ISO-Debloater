...
$scriptUrl = "https://alfmla.github.io/Windows-ISO-Debloater/isoDebloaterScript.ps1"
$autounattendXmlUrl = "https://alfmla.github.io/Windows-ISO-Debloater/autounattend.xml"
